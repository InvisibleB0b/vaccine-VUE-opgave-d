...
new Vue({
    ...
    methods: {
        ...
        async GetVaccines() {
            try {
                let response = await _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(baseUrl);
        ...
        async GetSpecificVaccine() {
            try {
                ...
                let response = await _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(baseUrl + `${this.idForSpecific}`);
        ...
        async CreateNewVaccine() {
            ...
            try {
                ...
                let response = await _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(baseUrl, postBody);
        ...
        async DeleteVaccine() {
            ...
            let response = await _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.delete(baseUrl + `${this.idToDelete}`);
        ...
        async GetBestVaccines() {
            try {
                let response = await _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(baseUrl + "best");
...
/***/ 0:
/*!**********************************************************************!*\
  !*** multi ./src/index.htm ./src/js/index.ts ./src/scss/styles.scss ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
